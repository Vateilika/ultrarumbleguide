...
These are very similar combosDo Gamma -> Alpha -> Alpha on HP and Hold Gamma -> Alpha on GP since you can only get the 2nd alpha if the opponent doesn't wake. This is your primary gamma combo starter if you don't have beta to combo after. 
<p align="center">
...
### Hold Gamma -> Air Melee -> Hold Gamma
It's very similar to the previous one just with a bit shorter range and more ammo cost in exchange for a good bit more damage.
