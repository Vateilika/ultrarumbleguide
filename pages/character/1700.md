...
<div style="display: flex; justify-content: space-between; align-items: center;">
  <h1 style="margin: 0;">
    <a href="https://ultrarumble.com/character/1#Variant-1" target="_blank" style="color: rgba(201,19,200,255) !important;">Dabi</a> Guide
  </h1>
  <em style="text-align: center; ">Guide developed and supervised by: Siridian (PS)</em><br>
  <em style="text-align: center; ">Contributors: Nugget (PS)</em>
</div>
