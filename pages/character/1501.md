...
<br>
The DMG of the following combos is classified under the tags "Light DMG", "Medium DMG", "High DMG", "Heavy DMG" and "Deadly DMG", given to combos that at max level do damage in the 200s, 300s, 400s, 500s and 600s respectively. For those that add "Alpha Mash", only two alphas will be counted.
