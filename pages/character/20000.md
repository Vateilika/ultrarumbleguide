...
### Extra Damage Drones: 1
### Blackphane (On enemy) -> Air Bash -> Air Melee 1 -> Air Melee 2 -> <a style="color: rgba(92,255,119,255) !important;">Flame Bullet Shot</a>
...
### Blackphane (On enemy) -> Air Melee 1 -> Air Melee 2 -> Gamma 2x -> Flame Bullet Shot

A useful combo to know for when you hit a Blackphane on a grounded enemy. Make sure you are only doing the Gamma 2x after the two air melees so you can keep the enemy staggered to confirm the Flame Bullet Shot.
...
### Blackphane (On environment) -> Air Bash -> Air Melee 1 -> Air Melee 2 ->  Gamma 2x -> Flame Bullet Shot
...
A combo you can use while grounded or in the air and manage to freeze someone. The hardest part about the combo is landing the freeze as some characters can easily evade your alphas but once the enemy is frozen it’s a free guard break for you. If you want to guarantee the freeze shoot the two drones out first to stagger the enemy and that buys you enough time to get the three Ice Bullet Shots off.
...
## Ice Bullet Shot -> Ice Bullet Shot -> Ice Bullet Shot -> Ice Bullet Shot -> Blackbolt -> Gamma 2x
...
## Ice Bullet Shot -> Ice Bullet Shot -> Ice Bullet Shot -> Ice Bullet Shot -> Air Melee 1 -> Air Melee 2 -> Gamma 2x -> Flame Bullet Shot
...
### Extra Damage Drones: 1
### Ice Bullet Shot -> Ice Bullet Shot -> Ice Bullet Shot -> Ice Bullet Shot -> Air Melee 1 -> Air Melee 2 -> <a style="color: rgba(255,100,100,255) !important;">Blackbolt</a>
...
It can be hard to track the cooldown of Special Action since you'll be using it so much and hold version takes 80% of the gauge. If you're in a fight and notice your Special Action getting low, consider getting on high ground and continuing your assualt from there so you aren't left on the ground where you're more likely to die. You could also adopt a more grounded position to fight your opponent while your Special Action reloads depending on the opponent so you're able to use Special Action against enemies who are better to use Special Action against like other Armored All Mights for example.
...
<section class="tuning-section">
    <article class="tuning-costume"> 
        ...
        <div class="tune-description">
            ...
            <p>A very flexible costume that has a lot of good Special Tuning combinations and has a healthy amount of damage slots and reload slots.</p>
        </div>
    </article>
</section> 
